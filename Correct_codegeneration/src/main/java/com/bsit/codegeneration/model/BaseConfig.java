...
public class BaseConfig {
    ...
    public boolean isBuilderPattern() { return builderPattern; }
    public void setBuilderPattern(boolean builderPattern) { this.builderPattern = builderPattern; }

    public String getPackageName() { return packageName; }
    public void setPackageName(String packageName) { this.packageName = packageName; }

    public boolean isUseJavaTime() { return useJavaTime; }
    public void setUseJavaTime(boolean useJavaTime) { this.useJavaTime = useJavaTime; }
    ...
    public boolean isIncludeReverseRelationships() { return includeReverseRelationships; }
    ...
    public boolean isRemoveForeignKeyIdFields() { return removeForeignKeyIdFields; }
    public void setRemoveForeignKeyIdFields(boolean removeForeignKeyIdFields) { this.removeForeignKeyIdFields = removeForeignKeyIdFields; }
}
