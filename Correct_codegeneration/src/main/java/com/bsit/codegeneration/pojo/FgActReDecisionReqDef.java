...
public class FgActReDecisionReqDef {
    ...
    private List<FgActReDecisionDef> fgActReDecisionDefList;

    public FgActReDecisionReqDef() {
    }

    public FgActReDecisionReqDef(String ID_, java.math.BigDecimal rev_, String category_, String name_, String key_, java.math.BigDecimal version_, String deploymentID_, String resourceName_, String dgrmResourceName_, String tenantID_) {
        this.ID_ = ID_;
        this.rev_ = rev_;
    ...
    public List<FgActReDecisionDef> getFgActReDecisionDefList() {
        return fgActReDecisionDefList;
    }

    public void setFgActReDecisionDefList(List<FgActReDecisionDef> fgActReDecisionDefList) {
        this.fgActReDecisionDefList = fgActReDecisionDefList;
    }

    public static class Builder {

        private FgActReDecisionReqDef instance = new FgActReDecisionReqDef();
        ...
        public Builder fgActReDecisionDefList(List<FgActReDecisionDef> fgActReDecisionDefList) {
            instance.setFgActReDecisionDefList(fgActReDecisionDefList);
            return this;
        }

        public FgActReDecisionReqDef build() {
            return instance;
        }
    }
}
