...
public class KmblScfFinReqBatch {
    ...
    public KmblScfFinReqBatch() {
    }

    public KmblScfFinReqBatch(Integer ID, Integer referenceID, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, Integer processID, String createdOn, java.math.BigDecimal createdBy, String lastUpdatedOn, java.math.BigDecimal lastUpdatedBy, String lastAuthorisedOn, java.math.BigDecimal lastAuthorisedBy, String template, String applicantParty, String fulfillmentParty, Integer isTemplate, String partyType, String customerCrn, String programLayout, java.time.LocalDateTime batchValueDate, Integer loanRefID, java.time.LocalDateTime loanDueDate, java.math.BigDecimal requestAmount, String ccy, String returnText, java.math.BigDecimal batchAmount, String limitNodeReference, java.math.BigDecimal snapshotLimit, String remarks) {
        this.ID = ID;
    ...
    public static class Builder {
        ...
        private KmblScfFinReqBatch instance = new KmblScfFinReqBatch();
