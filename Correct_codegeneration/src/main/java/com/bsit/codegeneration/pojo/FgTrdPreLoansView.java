...
public class FgTrdPreLoansView {
    ...
    public FgTrdPreLoansView() {
    }

    public FgTrdPreLoansView(Integer ID, Integer referenceID, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, String createdOn, java.math.BigDecimal createdBy, String lastUpdatedOn, java.math.BigDecimal lastUpdatedBy, String lastAuthorisedOn, java.math.BigDecimal lastAuthorisedBy, String template, Integer isTemplate, Integer preLoanRefID, Integer loanRefID, String curCode, java.math.BigDecimal principalOutstanding, Integer inLoanCur, java.math.BigDecimal dspAmt, java.math.BigDecimal equDspAmt, String applicantParty, java.time.LocalDateTime disbDate) {
        this.ID = ID;
    ...
    public Integer getInLoanCur() {
        return inLoanCur;
    }

    public void setInLoanCur(Integer inLoanCur) {
        this.inLoanCur = inLoanCur;
    }
    ...
    public static class Builder {
        ...
        private FgTrdPreLoansView instance = new FgTrdPreLoansView();
        ...
        public Builder inLoanCur(Integer inLoanCur) {
        ...
        public FgTrdPreLoansView build() {
            return instance;
        }
    }
}
