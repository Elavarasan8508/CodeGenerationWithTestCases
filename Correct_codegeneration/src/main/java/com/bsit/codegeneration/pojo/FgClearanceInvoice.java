...
public class FgClearanceInvoice {
    ...
    public static class Builder {
        ...
        private FgClearanceInvoice instance = new FgClearanceInvoice();
        ...
        public FgClearanceInvoice build() {
            return instance;
        }
    }
}
