...
public class FgSdkBusinessCode {
    ...
    public FgSdkBusinessCode() {
    }

    public FgSdkBusinessCode(Integer ID, Integer referenceID, String applicantPartyCode, Integer applicantRefID, String issuingPartyCode, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, String createdOn, java.math.BigDecimal createdBy, String lastUpdatedOn, java.math.BigDecimal lastUpdatedBy, String lastAuthorisedOn, java.math.BigDecimal lastAuthorisedBy, String template, Integer isTemplate, String codeType, String parentType, String parentCode, String templateCode, String description, String codeValue, String name, String activecode, Integer parentRefID, Integer parentVersionID) {
        this.ID = ID;
    ...
    public static class Builder {
        ...
        private FgSdkBusinessCode instance = new FgSdkBusinessCode();
        ...
        public FgSdkBusinessCode build() {
            return instance;
        }
    }
}
