...
public class Rental {
    ...
    public Rental(Integer rentalID, java.time.LocalDateTime rentalDate, Integer inventoryID, Integer customerID, java.time.LocalDateTime returnDate, Integer staffID, java.time.LocalDateTime lastUpdate, Customer customer, Inventory inventory, Staff staff) {
