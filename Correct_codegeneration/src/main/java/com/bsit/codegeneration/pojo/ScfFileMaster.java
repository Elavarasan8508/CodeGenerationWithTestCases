...
public class ScfFileMaster {
    ...
    public ScfFileMaster(Integer ID, Integer referenceID, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, String createdOn, java.math.BigDecimal createdBy, String lastUpdatedOn, java.math.BigDecimal lastUpdatedBy, String lastAuthorisedOn, java.math.BigDecimal lastAuthorisedBy, String template, Integer isTemplate, String anchorCrn, String fileName, String fileAttachRefNo, String fileStatus, String remarks, Long lineCount, Long txnCount, Long txnValSuccessCnt, Long txnListingCnt, Long txnListingAckCnt, Long finpayReqCnt, Long integritySuccessCnt, String stagestatus, Long finpayRespCnt, String anchorName, String displayFileName, String hashKey, String purposeCode, String displayStatus, String fullfilmentParty, String sourceOfCreation, String numberOfFields, String fintechSource) {
        ...
        this.fintechSource = fintechSource;
    }
    ...
    public String getFintechSource() {
        return fintechSource;
    }

    public void setFintechSource(String fintechSource) {
        this.fintechSource = fintechSource;
    }

    public static class Builder {

        private ScfFileMaster instance = new ScfFileMaster();
        ...
        public Builder numberOfFields(String numberOfFields) {
            instance.setNumberOfFields(numberOfFields);
            return this;
        }

        public Builder fintechSource(String fintechSource) {
            instance.setFintechSource(fintechSource);
            return this;
        }

        public ScfFileMaster build() {
            return instance;
        }
    }
}
