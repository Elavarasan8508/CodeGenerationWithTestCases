...
public class FgModCmsSpace {
    ...
    public static class Builder {
        ...
        private FgModCmsSpace instance = new FgModCmsSpace();
        ...
        public Builder parentSpaceCode(String parentSpaceCode) {
            instance.setParentSpaceCode(parentSpaceCode);
            return this;
        }
        ...
        public Builder visibilityCode(String visibilityCode) {
            instance.setVisibilityCode(visibilityCode);
            return this;
        }
