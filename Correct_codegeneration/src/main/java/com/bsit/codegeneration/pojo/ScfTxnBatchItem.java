...
public class ScfTxnBatchItem {
    ...
    public ScfTxnBatchItem() {
    }

    public ScfTxnBatchItem(Integer ID, Integer referenceID, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, String createdOn, java.math.BigDecimal createdBy, String lastUpdatedOn, java.math.BigDecimal lastUpdatedBy, String lastAuthorisedOn, java.math.BigDecimal lastAuthorisedBy, String template, Integer isTemplate, Integer batchRefID, Integer txnRefID, String anchorCrn, String txnTypeCode, String txnSubTypeCode) {
        this.ID = ID;
    ...
    public static class Builder {
        ...
        private ScfTxnBatchItem instance = new ScfTxnBatchItem();
