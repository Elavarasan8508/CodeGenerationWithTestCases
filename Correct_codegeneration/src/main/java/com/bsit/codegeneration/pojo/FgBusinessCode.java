...
public class FgBusinessCode {
    ...
    public FgBusinessCode() {
    }

    public FgBusinessCode(Integer ID, String name, String codeType, String codeValue, String parentCode, Integer partyID, Integer partyVersionID, String parentType, String description, String activeCode, String statusCode, String createdOn, java.math.BigDecimal createdBy, String lastUpdatedOn, java.math.BigDecimal lastUpdatedBy, String lastAuthorisedOn, java.math.BigDecimal lastAuthorisedBy, String template, Integer parentRefID, String tags, FgParty party, FgParty partyVersion) {
        this.ID = ID;
        this.name = name;
    ...
    public static class Builder {
        ...
        private FgBusinessCode instance = new FgBusinessCode();
