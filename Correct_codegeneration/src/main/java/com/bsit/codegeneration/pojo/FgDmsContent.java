...
public class FgDmsContent {
    ...
    private FgDmsTag dmsContent;

    private List<FgDmsTag> fgDmsTagList;

    public FgDmsContent() {
    }

    public FgDmsContent(Integer ID, String dmsDocPath, Integer dmsDocReferenceID, byte[] fileContent, String fileName, String fileSize, String fileType, String title, Integer dmsEventID, String description, String filePurposeCode, String dmsReference, String activeCode, String statusCode, String createdOn, java.math.BigDecimal createdBy, String lastUpdatedOn, java.math.BigDecimal lastUpdatedBy, String lastAuthorisedOn, java.math.BigDecimal lastAuthorisedBy, FgDmsTag dmsContent) {
        this.ID = ID;
    ...
    public FgDmsTag getDmsContent() {
        return dmsContent;
    }

    public void setDmsContent(FgDmsTag dmsContent) {
        this.dmsContent = dmsContent;
    }

    public List<FgDmsTag> getFgDmsTagList() {
        return fgDmsTagList;
    }

    public void setFgDmsTagList(List<FgDmsTag> fgDmsTagList) {
        this.fgDmsTagList = fgDmsTagList;
    }

    public static class Builder {

        private FgDmsContent instance = new FgDmsContent();
        ...
        public Builder dmsContent(FgDmsTag dmsContent) {
            instance.setDmsContent(dmsContent);
            return this;
        }

        public Builder fgDmsTagList(List<FgDmsTag> fgDmsTagList) {
            instance.setFgDmsTagList(fgDmsTagList);
            return this;
        }
