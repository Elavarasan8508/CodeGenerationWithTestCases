...
public class FgTokenClone {
    ...
    public FgTokenClone(Integer ID, String domainCode, String userName, Integer loginID, String tokenName, Integer status, String reqSystem, String issuedOn, String accessedOn, Integer valDuration, String reqTime, String expiresOn, String createdDate, java.math.BigDecimal createdBy, java.math.BigDecimal lastUpdatedBy, java.math.BigDecimal lastAuthorisedBy, String createdOn, String lastUpdatedOn, String lastAuthorisedOn, String tokenValue, String channel, String channelType) {
        this.ID = ID;
    ...
    public static class Builder {
        ...
        private FgTokenClone instance = new FgTokenClone();
