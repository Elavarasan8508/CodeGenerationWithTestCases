...
public class FgSettingCutoffBkp0410 {
    ...
    private java.math.BigDecimal corporateCrn;

    private String entityName;

    public FgSettingCutoffBkp0410() {
    }

    public FgSettingCutoffBkp0410(Integer ID, Integer referenceID, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, Integer processID, String createdOn, java.math.BigDecimal createdBy, String lastUpdatedOn, java.math.BigDecimal lastUpdatedBy, String lastAuthorisedOn, java.math.BigDecimal lastAuthorisedBy, String template, String applicantParty, String fulfillmentParty, Integer isTemplate, String scopeType, String productCode, String scopeLevel, String scopeValue, String subProductCode, Integer versionID, Integer isMasterVersion, java.math.BigDecimal rateType, String entityCode, Integer uploadRefID, String fgGroupScope, String fgRoleScope, java.math.BigDecimal corporateCrn, String entityName) {
        this.ID = ID;
    ...
    public String getFgGroupScope() {
        return fgGroupScope;
    }

    public void setFgGroupScope(String fgGroupScope) {
        this.fgGroupScope = fgGroupScope;
    }

    public String getFgRoleScope() {
        return fgRoleScope;
    }

    public void setFgRoleScope(String fgRoleScope) {
        this.fgRoleScope = fgRoleScope;
    }

    public java.math.BigDecimal getCorporateCrn() {
        return corporateCrn;
    }

    public void setCorporateCrn(java.math.BigDecimal corporateCrn) {
        this.corporateCrn = corporateCrn;
    }
    ...
    public static class Builder {
        ...
        private FgSettingCutoffBkp0410 instance = new FgSettingCutoffBkp0410();
        ...
        public Builder scopeType(String scopeType) {
            instance.setScopeType(scopeType);
            return this;
        }
        ...
        public Builder scopeLevel(String scopeLevel) {
            instance.setScopeLevel(scopeLevel);
            return this;
        }
        ...
        public Builder fgGroupScope(String fgGroupScope) {
            instance.setFgGroupScope(fgGroupScope);
            return this;
        }

        public Builder fgRoleScope(String fgRoleScope) {
            instance.setFgRoleScope(fgRoleScope);
            return this;
        }

        public Builder corporateCrn(java.math.BigDecimal corporateCrn) {
            instance.setCorporateCrn(corporateCrn);
            return this;
        }
