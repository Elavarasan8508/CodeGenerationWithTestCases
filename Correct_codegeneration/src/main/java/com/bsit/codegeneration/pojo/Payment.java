...
public class Payment {
    ...
    public Payment(Integer paymentID, Integer customerID, Integer staffID, Integer rentalID, java.math.BigDecimal amount, java.time.LocalDateTime paymentDate, java.time.LocalDateTime lastUpdate, Customer customer, Rental rental, Staff staff) {
