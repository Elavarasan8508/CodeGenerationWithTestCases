...
public class CustomerRegistration {
    ...
    public CustomerRegistration(Integer ID, Integer referenceID, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, Integer processID, String createdOn, java.math.BigDecimal createdBy, String lastUpdatedOn, java.math.BigDecimal lastUpdatedBy, String lastAuthorisedOn, java.math.BigDecimal lastAuthorisedBy, String template, String applicantParty, String fulfillmentParty, Integer isTemplate, String firstName, String lastName, java.time.LocalDateTime dateOfBirth, String address, Long mobile, Long alternateContactNumber) {
        this.ID = ID;
    ...
    public static class Builder {
        ...
        private CustomerRegistration instance = new CustomerRegistration();
        ...
        public Builder alternateContactNumber(Long alternateContactNumber) {
            instance.setAlternateContactNumber(alternateContactNumber);
            return this;
        }
