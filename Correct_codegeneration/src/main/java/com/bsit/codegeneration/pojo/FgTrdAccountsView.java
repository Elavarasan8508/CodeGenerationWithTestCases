...
public class FgTrdAccountsView {
    ...
    public FgTrdAccountsView() {
    }

    public FgTrdAccountsView(Integer ID, Integer referenceID, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, String createdOn, java.math.BigDecimal createdBy, String lastUpdatedOn, java.math.BigDecimal lastUpdatedBy, String lastAuthorisedOn, java.math.BigDecimal lastAuthorisedBy, String template, Integer isTemplate, String accNo, String curCode, String inAccCur, java.math.BigDecimal dspAmt, java.math.BigDecimal equDspAmt, String applicantParty) {
        this.ID = ID;
    ...
    public String getInAccCur() {
        return inAccCur;
    }

    public void setInAccCur(String inAccCur) {
        this.inAccCur = inAccCur;
    }
    ...
    public static class Builder {
        ...
        private FgTrdAccountsView instance = new FgTrdAccountsView();
        ...
        public FgTrdAccountsView build() {
            return instance;
        }
    }
}
