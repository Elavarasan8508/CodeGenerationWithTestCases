...
public class FgAutoloanSettlement {
    ...
    public static class Builder {
        ...
        private FgAutoloanSettlement instance = new FgAutoloanSettlement();
        ...
        public Builder partyName(String partyName) {
            instance.setPartyName(partyName);
            return this;
        }
