...
public class Address {
    ...
    public Address(Integer addressID, String address, String address2, String district, Integer cityID, String postalCode, String phone, java.time.LocalDateTime lastUpdate, City city, Staff managerStaff) {
