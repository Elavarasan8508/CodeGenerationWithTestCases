...
public class FgFintechUpload {
    ...
    public FgFintechUpload() {
    }

    public FgFintechUpload(Integer ID, Integer referenceID, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, Integer processID, String createdOn, java.math.BigDecimal createdBy, String lastUpdatedOn, java.math.BigDecimal lastUpdatedBy, String lastAuthorisedOn, java.math.BigDecimal lastAuthorisedBy, String template, String applicantPartyCode, String issuingPartyCode, Integer isTemplate, String channels, String transferStatus, Integer layoutTemplateID, String layoutName, byte[] filecontent, Integer uploadRefID, String fileName, Integer dmsEventID, String remarks) {
        this.ID = ID;
    ...
    public static class Builder {
        ...
        private FgFintechUpload instance = new FgFintechUpload();
        ...
        public Builder transferStatus(String transferStatus) {
            instance.setTransferStatus(transferStatus);
            return this;
        }
