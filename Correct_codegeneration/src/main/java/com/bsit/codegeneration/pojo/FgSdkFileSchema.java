...
public class FgSdkFileSchema {
    ...
    public FgSdkFileSchema() {
    }

    public FgSdkFileSchema(Integer ID, Integer referenceID, String applicantPartyCode, Integer applicantRefID, String issuingPartyCode, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, String createdOn, java.math.BigDecimal createdBy, String lastUpdatedOn, java.math.BigDecimal lastUpdatedBy, String lastAuthorisedOn, java.math.BigDecimal lastAuthorisedBy, String template, Integer isTemplate, String name, String entitySubTypeCode) {
        this.ID = ID;
    ...
    public static class Builder {
        ...
        private FgSdkFileSchema instance = new FgSdkFileSchema();
