...
public class FgAgentRepositoryEvent {
    ...
    public static class Builder {
        ...
        private FgAgentRepositoryEvent instance = new FgAgentRepositoryEvent();
        ...
        public Builder agentRefID(Integer agentRefID) {
            instance.setAgentRefID(agentRefID);
            return this;
        }
        ...
        public FgAgentRepositoryEvent build() {
            return instance;
        }
    }
}
