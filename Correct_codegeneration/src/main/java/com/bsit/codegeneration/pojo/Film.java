...
public class Film {
    ...
    public Film(Integer filmID, String title, String description, Integer releaseYear, Integer languageID, Integer originalLanguageID, Integer rentalDuration, java.math.BigDecimal rentalRate, Integer length, java.math.BigDecimal replacementCost, String rating, String specialFeatures, java.time.LocalDateTime lastUpdate, Language language, Language originalLanguage, FilmActor film, Category category, Actor actor) {
        this.filmID = filmID;
        this.title = title;
