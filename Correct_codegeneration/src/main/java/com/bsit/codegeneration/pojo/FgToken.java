...
public class FgToken {
    ...
    public FgToken(Integer ID, String domainCode, String userName, Integer loginID, String tokenName, Integer status, String reqSystem, String issuedOn, String accessedOn, Integer valDuration, String reqTime, String expiresOn, String createdDate, java.math.BigDecimal createdBy, java.math.BigDecimal lastUpdatedBy, java.math.BigDecimal lastAuthorisedBy, String createdOn, String lastUpdatedOn, String lastAuthorisedOn, String tokenValue, String channel, String channelType, String externalToken) {
        this.ID = ID;
    ...
    public static class Builder {
        ...
        private FgToken instance = new FgToken();
        ...
        public Builder externalToken(String externalToken) {
            instance.setExternalToken(externalToken);
            return this;
        }
