...
public class FgSdkUploadSchema {
    ...
    public FgSdkUploadSchema() {
    }

    public FgSdkUploadSchema(Integer ID, Integer referenceID, String applicantPartyCode, Integer applicantRefID, String issuingPartyCode, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, String createdOn, java.math.BigDecimal createdBy, String lastUpdatedOn, java.math.BigDecimal lastUpdatedBy, String lastAuthorisedOn, java.math.BigDecimal lastAuthorisedBy, String template, Integer isTemplate, Integer layoutTemplateID) {
        this.ID = ID;
    ...
    public static class Builder {
        ...
        private FgSdkUploadSchema instance = new FgSdkUploadSchema();
