...
public class FgAutoloanAcct {
    ...
    private java.math.BigDecimal maxSetAmount;
    ...
    public FgAutoloanAcct() {
    }

    public FgAutoloanAcct(Integer ID, Integer referenceID, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, Integer processID, String createdOn, java.math.BigDecimal createdBy, String lastUpdatedOn, java.math.BigDecimal lastUpdatedBy, String lastAuthorisedOn, java.math.BigDecimal lastAuthorisedBy, String template, String applicantParty, String fulfillmentParty, Integer isTemplate, String acctNum, String productCode, String maxSetPercent, java.math.BigDecimal maxSetAmount, Integer parentRefID, Integer parentVersionID, String logicSettle) {
        this.ID = ID;
    ...
    public String getMaxSetPercent() {
        return maxSetPercent;
    }

    public void setMaxSetPercent(String maxSetPercent) {
        this.maxSetPercent = maxSetPercent;
    }

    public java.math.BigDecimal getMaxSetAmount() {
        return maxSetAmount;
    }

    public void setMaxSetAmount(java.math.BigDecimal maxSetAmount) {
        this.maxSetAmount = maxSetAmount;
    }
    ...
    public String getLogicSettle() {
        return logicSettle;
    }

    public void setLogicSettle(String logicSettle) {
        this.logicSettle = logicSettle;
    }

    public static class Builder {

        private FgAutoloanAcct instance = new FgAutoloanAcct();
        ...
        public Builder maxSetPercent(String maxSetPercent) {
            instance.setMaxSetPercent(maxSetPercent);
            return this;
        }

        public Builder maxSetAmount(java.math.BigDecimal maxSetAmount) {
            instance.setMaxSetAmount(maxSetAmount);
            return this;
        }
        ...
        public Builder logicSettle(String logicSettle) {
            instance.setLogicSettle(logicSettle);
            return this;
        }
