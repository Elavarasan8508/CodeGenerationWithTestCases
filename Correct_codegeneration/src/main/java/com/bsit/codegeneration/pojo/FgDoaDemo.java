...
public class FgDoaDemo {
    ...
    public Long getCustomerCrn() {
        return customerCrn;
    }

    public void setCustomerCrn(Long customerCrn) {
        this.customerCrn = customerCrn;
    }
    ...
    public static class Builder {
        ...
        private FgDoaDemo instance = new FgDoaDemo();
