...
public class FgUploadError {
    ...
    public FgUploadError() {
    }

    public FgUploadError(Integer ID, Integer referenceID, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, String createdOn, java.math.BigDecimal createdBy, String lastUpdatedOn, java.math.BigDecimal lastUpdatedBy, String lastAuthorisedOn, java.math.BigDecimal lastAuthorisedBy, String template, Integer isTemplate, Integer uploadID, String errorCode, String gravity, String errorValue, Long lineNo, Long columnNo, Integer parentRefID, Integer parentVersionID) {
        this.ID = ID;
    ...
    public static class Builder {
        ...
        private FgUploadError instance = new FgUploadError();
