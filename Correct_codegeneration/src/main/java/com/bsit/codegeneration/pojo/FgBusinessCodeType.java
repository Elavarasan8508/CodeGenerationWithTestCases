...
public class FgBusinessCodeType {
    ...
    public FgBusinessCodeType() {
    }

    public FgBusinessCodeType(Integer ID, Integer partyID, Integer partyVersionID, String codeType, String name, String description, String activeCode, String createdOn, java.math.BigDecimal createdBy, String lastUpdatedOn, java.math.BigDecimal lastUpdatedBy, String lastAuthorisedOn, java.math.BigDecimal lastAuthorisedBy, String tags) {
        this.ID = ID;
    ...
    public static class Builder {
        ...
        private FgBusinessCodeType instance = new FgBusinessCodeType();
