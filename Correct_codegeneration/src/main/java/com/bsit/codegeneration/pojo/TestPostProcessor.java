...
public class TestPostProcessor {
    ...
    public TestPostProcessor(Integer ID, Integer referenceID, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, Integer processID, String createdOn, java.math.BigDecimal createdBy, String lastUpdatedOn, java.math.BigDecimal lastUpdatedBy, String lastAuthorisedOn, java.math.BigDecimal lastAuthorisedBy, String template, String applicantParty, String fulfillmentParty, Integer isTemplate, String value1, String value2, String entityTypeCode, String entitySubTypeCode, Integer entityReferenceID) {
        this.ID = ID;
    ...
    public static class Builder {
        ...
        private TestPostProcessor instance = new TestPostProcessor();
        ...
        public TestPostProcessor build() {
            return instance;
        }
    }
}
