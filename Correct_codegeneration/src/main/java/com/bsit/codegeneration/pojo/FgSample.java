...
public class FgSample {
    ...
    public Long getFgSampleApp() {
        return fgSampleApp;
    }

    public void setFgSampleApp(Long fgSampleApp) {
        this.fgSampleApp = fgSampleApp;
    }

    public static class Builder {

        private FgSample instance = new FgSample();
        ...
        public Builder fgSampleApp(Long fgSampleApp) {
            instance.setFgSampleApp(fgSampleApp);
            return this;
        }
