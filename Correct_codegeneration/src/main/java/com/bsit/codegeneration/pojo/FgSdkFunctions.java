...
public class FgSdkFunctions {
    ...
    public FgSdkFunctions() {
    }

    public FgSdkFunctions(Integer ID, Integer referenceID, String applicantPartyCode, Integer applicantRefID, String issuingPartyCode, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, String createdOn, java.math.BigDecimal createdBy, String lastUpdatedOn, java.math.BigDecimal lastUpdatedBy, String lastAuthorisedOn, java.math.BigDecimal lastAuthorisedBy, String template, Integer isTemplate, String name) {
        this.ID = ID;
    ...
    public static class Builder {
        ...
        private FgSdkFunctions instance = new FgSdkFunctions();
