...
public class LmsMdmFtp {
    ...
    private java.time.LocalDateTime effectiveStartDate;

    private java.time.LocalDateTime effectiveEndDate;

    public LmsMdmFtp() {
    }

    public LmsMdmFtp(Integer ID, Integer referenceID, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, Integer processID, String createdOn, java.math.BigDecimal createdBy, String lastUpdatedOn, java.math.BigDecimal lastUpdatedBy, String lastAuthorisedOn, java.math.BigDecimal lastAuthorisedBy, String template, String applicantParty, String fulfillmentParty, Integer attachmentID, Integer parentID, Integer parentRefID, Integer parentVersionID, Integer isTemplate, Long tenorStartSlab, Long tenorEndSlab, String tenorUomCode, String tenorSlabRuleExpression, java.math.BigDecimal rateOfInterest, Integer uploadRefID, String ftpStatusCode, String ruleType, String segmentCode, String productCode, String subProductCode, java.time.LocalDateTime effectiveStartDate, java.time.LocalDateTime effectiveEndDate) {
        this.ID = ID;
    ...
    public Long getTenorStartSlab() {
        return tenorStartSlab;
    }

    public void setTenorStartSlab(Long tenorStartSlab) {
        this.tenorStartSlab = tenorStartSlab;
    }

    public Long getTenorEndSlab() {
        return tenorEndSlab;
    }

    public void setTenorEndSlab(Long tenorEndSlab) {
        this.tenorEndSlab = tenorEndSlab;
    }

    public String getTenorUomCode() {
        return tenorUomCode;
    }

    public void setTenorUomCode(String tenorUomCode) {
        this.tenorUomCode = tenorUomCode;
    }

    public String getTenorSlabRuleExpression() {
        return tenorSlabRuleExpression;
    }

    public void setTenorSlabRuleExpression(String tenorSlabRuleExpression) {
        this.tenorSlabRuleExpression = tenorSlabRuleExpression;
    }
    ...
    public String getFtpStatusCode() {
        return ftpStatusCode;
    }

    public void setFtpStatusCode(String ftpStatusCode) {
        this.ftpStatusCode = ftpStatusCode;
    }
    ...
    public java.time.LocalDateTime getEffectiveStartDate() {
        return effectiveStartDate;
    }

    public void setEffectiveStartDate(java.time.LocalDateTime effectiveStartDate) {
        this.effectiveStartDate = effectiveStartDate;
    }

    public java.time.LocalDateTime getEffectiveEndDate() {
        return effectiveEndDate;
    }

    public void setEffectiveEndDate(java.time.LocalDateTime effectiveEndDate) {
        this.effectiveEndDate = effectiveEndDate;
    }

    public static class Builder {

        private LmsMdmFtp instance = new LmsMdmFtp();
        ...
        public Builder tenorStartSlab(Long tenorStartSlab) {
            instance.setTenorStartSlab(tenorStartSlab);
            return this;
        }

        public Builder tenorEndSlab(Long tenorEndSlab) {
            instance.setTenorEndSlab(tenorEndSlab);
            return this;
        }

        public Builder tenorUomCode(String tenorUomCode) {
            instance.setTenorUomCode(tenorUomCode);
            return this;
        }

        public Builder tenorSlabRuleExpression(String tenorSlabRuleExpression) {
            instance.setTenorSlabRuleExpression(tenorSlabRuleExpression);
            return this;
        }
        ...
        public Builder ftpStatusCode(String ftpStatusCode) {
            instance.setFtpStatusCode(ftpStatusCode);
            return this;
        }
        ...
        public Builder effectiveStartDate(java.time.LocalDateTime effectiveStartDate) {
            instance.setEffectiveStartDate(effectiveStartDate);
            return this;
        }

        public Builder effectiveEndDate(java.time.LocalDateTime effectiveEndDate) {
            instance.setEffectiveEndDate(effectiveEndDate);
            return this;
        }

        public LmsMdmFtp build() {
            return instance;
        }
    }
}
