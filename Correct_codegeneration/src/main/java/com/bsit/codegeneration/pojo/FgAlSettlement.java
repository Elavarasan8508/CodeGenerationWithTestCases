...
public class FgAlSettlement {
    ...
    public FgAlSettlement() {
    }

    public FgAlSettlement(Integer ID, Integer referenceID, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, String createdOn, java.math.BigDecimal createdBy, String lastUpdatedOn, java.math.BigDecimal lastUpdatedBy, String lastAuthorisedOn, java.math.BigDecimal lastAuthorisedBy, String template, Integer isTemplate, String customerCrn, String accountNumber, Integer processID, Integer isMasterVersion, Integer versionID) {
        this.ID = ID;
    ...
    public static class Builder {
        ...
        private FgAlSettlement instance = new FgAlSettlement();
