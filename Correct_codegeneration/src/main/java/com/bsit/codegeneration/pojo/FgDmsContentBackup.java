...
public class FgDmsContentBackup {
    ...
    public FgDmsContentBackup() {
    }

    public FgDmsContentBackup(Integer ID, String dmsDocPath, Integer dmsDocReferenceID, byte[] fileContent, String fileName, String fileSize, String fileType, String title, Integer dmsEventID, String description, String filePurposeCode, String dmsReference, String activeCode, String statusCode, String createdOn, java.math.BigDecimal createdBy, String lastUpdatedOn, java.math.BigDecimal lastUpdatedBy, String lastAuthorisedOn, java.math.BigDecimal lastAuthorisedBy) {
        this.ID = ID;
    ...
    public static class Builder {
        ...
        private FgDmsContentBackup instance = new FgDmsContentBackup();
