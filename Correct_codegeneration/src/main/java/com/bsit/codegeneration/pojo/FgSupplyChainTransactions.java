...
public class FgSupplyChainTransactions {
    ...
    public FgSupplyChainTransactions() {
    }

    public FgSupplyChainTransactions(Integer ID, Integer referenceID, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, Integer processID, String createdOn, java.math.BigDecimal createdBy, String lastUpdatedOn, java.math.BigDecimal lastUpdatedBy, String lastAuthorisedOn, java.math.BigDecimal lastAuthorisedBy, String template, String applicantParty, String fulfillmentParty, Integer isTemplate, String invoiceNo, java.math.BigDecimal invoiceAmount, java.time.LocalDateTime invoiceDate, java.time.LocalDateTime dueDate, Integer uploadRefID) {
        this.ID = ID;
    ...
    public static class Builder {
        ...
        private FgSupplyChainTransactions instance = new FgSupplyChainTransactions();
        ...
        public FgSupplyChainTransactions build() {
            return instance;
        }
    }
}
