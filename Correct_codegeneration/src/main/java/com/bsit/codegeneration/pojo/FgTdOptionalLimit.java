...
public class FgTdOptionalLimit {
    ...
    public FgTdOptionalLimit() {
    }

    public FgTdOptionalLimit(Integer ID, Integer referenceID, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, Integer processID, String createdOn, java.math.BigDecimal createdBy, String lastUpdatedOn, java.math.BigDecimal lastUpdatedBy, String lastAuthorisedOn, java.math.BigDecimal lastAuthorisedBy, String template, Integer isTemplate, String schemeCode, Long tenorStartDays, Long tenorEndDays, java.math.BigDecimal tenorMinAmount, java.math.BigDecimal tenorMaxAmount, java.time.LocalDateTime valueDate, Integer parentRefID, Integer parentVersionID, Integer versionID, Integer isMasterVersion, String taskReason, java.time.LocalDateTime startDate, java.time.LocalDateTime endDate, String origin) {
        this.ID = ID;
    ...
    public Long getTenorStartDays() {
        return tenorStartDays;
    }

    public void setTenorStartDays(Long tenorStartDays) {
        this.tenorStartDays = tenorStartDays;
    }

    public Long getTenorEndDays() {
        return tenorEndDays;
    }

    public void setTenorEndDays(Long tenorEndDays) {
        this.tenorEndDays = tenorEndDays;
    }
    ...
    public static class Builder {
        ...
        private FgTdOptionalLimit instance = new FgTdOptionalLimit();
