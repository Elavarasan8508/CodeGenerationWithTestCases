...
public class FgScfMaTransactions {
    ...
    public FgScfMaTransactions() {
    }

    public FgScfMaTransactions(Integer ID, Integer referenceID, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, Integer processID, String createdOn, java.math.BigDecimal createdBy, String lastUpdatedOn, java.math.BigDecimal lastUpdatedBy, String lastAuthorisedOn, java.math.BigDecimal lastAuthorisedBy, String template, String applicantParty, String fulfillmentParty, Integer isTemplate, Integer refID, String invoiceNo, java.time.LocalDateTime invoiceDate, String vendorCode) {
        this.ID = ID;
    ...
    public static class Builder {
        ...
        private FgScfMaTransactions instance = new FgScfMaTransactions();
