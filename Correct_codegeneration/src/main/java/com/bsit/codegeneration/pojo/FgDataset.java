...
public class FgDataset {
    ...
    public FgDataset(Integer ID, Integer datasourceID, String code, String name, String modelCode, String config, String description, String activeCode, String statusCode, String createdOn, java.math.BigDecimal createdBy, String lastUpdatedOn, java.math.BigDecimal lastUpdatedBy, String lastAuthorisedOn, java.math.BigDecimal lastAuthorisedBy, String uuid, String masterTemplate, String masterContentHash, Integer isMasterVersion, Integer versionID) {
        this.ID = ID;
    ...
    public static class Builder {
        ...
        private FgDataset instance = new FgDataset();
