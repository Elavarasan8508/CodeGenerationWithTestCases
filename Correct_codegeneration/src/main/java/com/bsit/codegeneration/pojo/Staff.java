...
public class Staff {
    ...
    public Staff(Integer staffID, String firstName, String lastName, Integer addressID, String email, Integer storeID, Boolean active, String username, String password, java.time.LocalDateTime lastUpdate, String picture, Address address, Store store, Store managerStaff) {
