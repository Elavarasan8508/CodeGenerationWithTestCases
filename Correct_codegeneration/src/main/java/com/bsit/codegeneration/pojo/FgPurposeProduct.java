...
public class FgPurposeProduct {
    ...
    public FgPurposeProduct() {
    }

    public FgPurposeProduct(Integer ID, Integer referenceID, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, String createdOn, java.math.BigDecimal createdBy, String lastUpdatedOn, java.math.BigDecimal lastUpdatedBy, String lastAuthorisedOn, java.math.BigDecimal lastAuthorisedBy, String template, Integer isTemplate, String code, String productType, Integer parentRefID, Integer parentVersionID) {
        this.ID = ID;
    ...
    public static class Builder {
        ...
        private FgPurposeProduct instance = new FgPurposeProduct();
