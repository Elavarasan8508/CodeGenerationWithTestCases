...
public record FgDmsContentCopy(Integer ID, String dmsDocPath, Integer dmsDocReferenceID, String fileContent, String fileName, String fileSize, String fileType, String title, Integer dmsEventID, String description, String filePurposeCode, String dmsReference, String activeCode, String statusCode, String createdOn, Long createdBy, String lastUpdatedOn, Long lastUpdatedBy, String lastAuthorisedOn, Long lastAuthorisedBy) {
    ...
    public static class Builder {
        ...
        public FgDmsContentCopy build() {
            return new FgDmsContentCopy(ID, dmsDocPath, dmsDocReferenceID, fileContent, fileName, fileSize, fileType, title, dmsEventID, description, filePurposeCode, dmsReference, activeCode, statusCode, createdOn, createdBy, lastUpdatedOn, lastUpdatedBy, lastAuthorisedOn, lastAuthorisedBy);
        }
    }
}
