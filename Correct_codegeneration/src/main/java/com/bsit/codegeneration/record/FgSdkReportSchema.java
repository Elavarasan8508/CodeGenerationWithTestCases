...
public record FgSdkReportSchema(Integer ID, Integer referenceID, String applicantPartyCode, Integer applicantRefID, String issuingPartyCode, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, String createdOn, Long createdBy, String lastUpdatedOn, Long lastUpdatedBy, String lastAuthorisedOn, Long lastAuthorisedBy, String template, Long isTemplate, Integer processID, String modelProperties, String name, String description, String type, String entitySubTypeCode) {
    ...
    public static class Builder {
        ...
        public FgSdkReportSchema build() {
            return new FgSdkReportSchema(ID, referenceID, applicantPartyCode, applicantRefID, issuingPartyCode, typeCode, subTypeCode, activeCode, stageCode, statusCode, createdOn, createdBy, lastUpdatedOn, lastUpdatedBy, lastAuthorisedOn, lastAuthorisedBy, template, isTemplate, processID, modelProperties, name, description, type, entitySubTypeCode);
        }
    }
}
