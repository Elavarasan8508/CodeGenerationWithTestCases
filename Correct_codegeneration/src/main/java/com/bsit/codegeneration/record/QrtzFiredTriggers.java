...
public record QrtzFiredTriggers(String schedName, Integer entryID, String triggerName, String triggerGroup, String instanceName, Long firedTime, Long schedTime, Long priority, String state, String jobName, String jobGroup, String isNonconcurrent, String requestsRecovery) {
