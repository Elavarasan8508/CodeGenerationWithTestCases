...
public record QrtzSimpropTriggers(String schedName, String triggerName, String triggerGroup, String strProp1, String strProp2, String strProp3, Long intProp1, Long intProp2, Long longProp1, Long longProp2, Long decProp1, Long decProp2, String boolProp1, String boolProp2, Integer timeZoneID, QrtzTriggers qrtzTriggers) {
    ...
    public static class Builder {
        ...
        public QrtzSimpropTriggers build() {
            return new QrtzSimpropTriggers(schedName, triggerName, triggerGroup, strProp1, strProp2, strProp3, intProp1, intProp2, longProp1, longProp2, decProp1, decProp2, boolProp1, boolProp2, timeZoneID, qrtzTriggers);
        }
    }
}
