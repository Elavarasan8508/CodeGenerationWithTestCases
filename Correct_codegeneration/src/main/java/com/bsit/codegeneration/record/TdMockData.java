...
public record TdMockData(Integer bankID, String accountName, String tdAccountNo, String tdAccTemp, Integer cifID, Long depositAmount, Long maturityAmount, java.time.LocalDateTime effectiveDate, java.time.LocalDateTime maturityDate, Long availableAmount, java.time.LocalDateTime endDate, Long interestRate, String linkedAccount, String branch) {
