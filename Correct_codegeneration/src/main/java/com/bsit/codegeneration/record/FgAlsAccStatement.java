...
public record FgAlsAccStatement(Integer ID, Integer referenceID, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, Integer processID, String createdOn, Long createdBy, String lastUpdatedOn, Long lastUpdatedBy, String lastAuthorisedOn, Long lastAuthorisedBy, String template, String applicantParty, String fulfillmentParty, Long isTemplate, String txnType, java.time.LocalDateTime transactionDate, String virtualAccountNumber, java.time.LocalDateTime valueDate, String remarks, String particulars, String currency, Long debitAmount, Long creditAmount, Long balance, String txnStatus, String ledgerType, String tiTheirReference) {
