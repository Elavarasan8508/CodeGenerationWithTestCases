...
public record FgReportTemplate(Integer ID, Integer referenceID, String typeCode, String subTypeCode, String partyCode, String templateType, String reportType, String fileName, String fileType, String fileSize, String templateValue, String activeCode, String statusCode, String createdOn, Long createdBy, String lastUpdatedOn, Long lastUpdatedBy, String lastAuthorisedOn, Long lastAuthorisedBy, String name, Integer attachmentID) {
