...
public record FgApplication(Integer ID, String code, String name, String subTitle, String icon, String description, String navigationSchema, Long isSecured, String activeCode, String applicationType, Integer uuid, String tags, String appTitle, String deviceChannel, String createdOn, Long createdBy, String lastUpdatedOn, Long lastUpdatedBy, String lastAuthorisedOn, Long lastAuthorisedBy, String masterTemplate, String masterContentHash, Long isMasterVersion, Integer versionID) {
