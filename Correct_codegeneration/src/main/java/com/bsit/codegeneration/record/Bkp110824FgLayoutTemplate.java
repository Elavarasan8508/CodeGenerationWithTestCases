...
public record Bkp110824FgLayoutTemplate(Integer ID, String fileExtension, String fileType, String name, String template, String typeCode, String subTypeCode, String description, String activeCode, String statusCode, String createdOn, Long createdBy, String lastUpdatedOn, Long lastUpdatedBy, String lastAuthorisedOn, Long lastAuthorisedBy, Integer processID, Integer referenceID, String category, String content, Integer uuid, String categoryType, String categorySubType, String tags, Integer versionID, Long isMasterVersion, String stageCode, String applicantPartyCode, String deviceType, Long versionNo, String masterContentHash, String templateHash) {
