...
public record FgSdkScheduleRule(Integer ID, Integer referenceID, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, Integer processID, String createdOn, Long createdBy, String lastUpdatedOn, Long lastUpdatedBy, String lastAuthorisedOn, Long lastAuthorisedBy, String template, String applicantParty, String fulfillmentParty, Long isTemplate, String scheduleType, String subscriptionName, String ownerOrgTypeCode, String ownerOrgCode, String subscriberOrgTypeCode, String subscriberOrgCode, String cronExpression, String scheduleChannelCode, Integer alertTemplateID, String externalEmail, String channelEmailTitle, String channelEmailContent, String scheduleStartDate, String scheduleEndDate, Integer h2hDatasourceID, Integer h2hDatasetID, String entitySubTypeCode, Integer sourceRefID, Integer versionID, Long isMasterVersion, String cronObj) {
    ...
    public static class Builder {
        ...
        private Integer alertTemplateID;
        ...
        private Integer h2hDatasourceID;

        private Integer h2hDatasetID;
        ...
        public Builder alertTemplateID(Integer alertTemplateID) {
        ...
        public Builder h2hDatasourceID(Integer h2hDatasourceID) {
            this.h2hDatasourceID = h2hDatasourceID;
            return this;
        }

        public Builder h2hDatasetID(Integer h2hDatasetID) {
