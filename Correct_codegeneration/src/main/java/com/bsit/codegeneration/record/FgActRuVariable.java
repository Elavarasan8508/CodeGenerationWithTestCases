...
public record FgActRuVariable(String ID_, Long rev_, String type_, String name_, String executionID_, String procInstID_, String caseExecutionID_, String caseInstID_, String taskID_, String bytearrayID_, Long double_, Long long_, String text_, String text2_, String varScope_, Long sequenceCounter_, Long isConcurrentLocal_, String tenantID_, String procDefID_, String batchID_, FgActGeBytearray fgActGeBytearray, FgActRuBatch fgActRuBatch, FgActRuCaseExecution fgActRuCaseExecution) {
    ...
    public static class Builder {
        ...
        private FgActGeBytearray fgActGeBytearray;

        private FgActRuBatch fgActRuBatch;
        ...
        public Builder fgActGeBytearray(FgActGeBytearray fgActGeBytearray) {
            this.fgActGeBytearray = fgActGeBytearray;
            return this;
        }

        public Builder fgActRuBatch(FgActRuBatch fgActRuBatch) {
            this.fgActRuBatch = fgActRuBatch;
            return this;
        }
        ...
        public FgActRuVariable build() {
            return new FgActRuVariable(ID_, rev_, type_, name_, executionID_, procInstID_, caseExecutionID_, caseInstID_, taskID_, bytearrayID_, double_, long_, text_, text2_, varScope_, sequenceCounter_, isConcurrentLocal_, tenantID_, procDefID_, batchID_, fgActGeBytearray, fgActRuBatch, fgActRuCaseExecution);
        }
    }
}
