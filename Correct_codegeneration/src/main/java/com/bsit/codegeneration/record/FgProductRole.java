...
public record FgProductRole(String entityTypeCode, String entitySubTypeCode, String partyTypeCode, String partySubTypeCode, String partyRoleCode, Integer entityRefID, Long entityVersionNo, String partyCode, java.time.LocalDateTime validFrom, java.time.LocalDateTime validTo, String activeCode, String statusCode, String createdOn, Long createdBy, String lastUpdatedOn, Long lastUpdatedBy, String lastAuthorisedOn, Long lastAuthorisedBy, Integer uploadRefID, Integer ID) {
