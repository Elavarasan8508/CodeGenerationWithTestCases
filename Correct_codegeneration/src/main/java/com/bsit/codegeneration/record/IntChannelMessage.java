...
public record IntChannelMessage(Integer messageID, String groupKey, Long createdDate, Long messagePriority, Long messageSequence, String messageBytes, String region) {
