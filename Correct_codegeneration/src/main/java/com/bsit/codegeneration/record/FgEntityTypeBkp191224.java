...
public record FgEntityTypeBkp191224(Integer ID, String categoryCode, String code, String name, String parentTypeCode, Long isMaster, Long isProduct, String entityClassCode, Long configStatusCode, String description, String activeCode, String statusCode, String createdOn, Long createdBy, String lastUpdatedOn, Long lastUpdatedBy, String lastAuthorisedOn, Long lastAuthorisedBy, String templateSchema, Long isAnalyticsEnabled, Long isReportEnabled, String tags, Long isPublic, String masterTemplate, String masterContentHash, String templateHash, Integer versionID, Long isMasterVersion) {
    ...
    public static class Builder {
        ...
        public FgEntityTypeBkp191224 build() {
            return new FgEntityTypeBkp191224(ID, categoryCode, code, name, parentTypeCode, isMaster, isProduct, entityClassCode, configStatusCode, description, activeCode, statusCode, createdOn, createdBy, lastUpdatedOn, lastUpdatedBy, lastAuthorisedOn, lastAuthorisedBy, templateSchema, isAnalyticsEnabled, isReportEnabled, tags, isPublic, masterTemplate, masterContentHash, templateHash, versionID, isMasterVersion);
        }
    }
}
