...
public record FgLmsChargeSchemes(Integer ID, Integer referenceID, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, Integer processID, String createdOn, Long createdBy, String lastUpdatedOn, Long lastUpdatedBy, String lastAuthorisedOn, Long lastAuthorisedBy, String template, String applicantParty, String fulfillmentParty, Long isTemplate, String schemeName, String schemeDescription, String productCode, String productDescription, java.time.LocalDateTime effectiveDate, java.time.LocalDateTime expiryDate, Integer versionID, Long isMasterVersion, String product, String subProduct) {
