...
public record FgBusinessCodeBkp(Integer ID, String name, String codeType, String codeValue, String parentCode, Integer partyID, Integer partyVersionID, String parentType, String description, String activeCode, String statusCode, String createdOn, Long createdBy, String lastUpdatedOn, Long lastUpdatedBy, String lastAuthorisedOn, Long lastAuthorisedBy, String template, Integer parentRefID, String tags) {
