...
public record FgActRuExtTask(String ID_, Long rev_, String workerID_, String topicName_, Long retries_, String errorMsg_, String errorDetailsID_, String lockExpTime_, Long suspensionState_, String executionID_, String procInstID_, String procDefID_, String procDefKey_, String actID_, String actInstID_, String tenantID_, Long priority_, FgActGeBytearray fgActGeBytearray) {
    ...
    public static class Builder {
        ...
        public FgActRuExtTask build() {
            return new FgActRuExtTask(ID_, rev_, workerID_, topicName_, retries_, errorMsg_, errorDetailsID_, lockExpTime_, suspensionState_, executionID_, procInstID_, procDefID_, procDefKey_, actID_, actInstID_, tenantID_, priority_, fgActGeBytearray);
        }
    }
}
