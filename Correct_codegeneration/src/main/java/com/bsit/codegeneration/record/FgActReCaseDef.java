...
public record FgActReCaseDef(String ID_, Long rev_, String category_, String name_, String key_, Long version_, String deploymentID_, String resourceName_, String dgrmResourceName_, String tenantID_, Long historyTtl_, List<FgActRuCaseExecution> fgActRuCaseExecutions, List<FgActRuTask> fgActRuTasks) {
    ...
    public static class Builder {
        ...
        private List<FgActRuCaseExecution> fgActRuCaseExecutions;
        ...
        public Builder fgActRuCaseExecutions(List<FgActRuCaseExecution> fgActRuCaseExecutions) {
            this.fgActRuCaseExecutions = fgActRuCaseExecutions;
            return this;
        }
        ...
        public FgActReCaseDef build() {
            return new FgActReCaseDef(ID_, rev_, category_, name_, key_, version_, deploymentID_, resourceName_, dgrmResourceName_, tenantID_, historyTtl_, fgActRuCaseExecutions, fgActRuTasks);
        }
    }
}
