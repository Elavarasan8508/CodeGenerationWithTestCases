...
public record LmsMdmFtp(Integer ID, Integer referenceID, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, Integer processID, String createdOn, Long createdBy, String lastUpdatedOn, Long lastUpdatedBy, String lastAuthorisedOn, Long lastAuthorisedBy, String template, String applicantParty, String fulfillmentParty, Integer attachmentID, Integer parentID, Integer parentRefID, Integer parentVersionID, Long isTemplate, Long tenorStartSlab, Long tenorEndSlab, String tenorUomCode, String tenorSlabRuleExpression, Long rateOfInterest, Integer uploadRefID, String ftpStatusCode, String ruleType, String segmentCode, String productCode, String subProductCode, java.time.LocalDateTime effectiveStartDate, java.time.LocalDateTime effectiveEndDate) {
