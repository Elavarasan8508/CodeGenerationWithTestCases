...
public record FgParty(Integer ID, Integer versionID, Long isMasterVersion, String isoCode, String languageCode, String name, String timeZoneCode, String typeCode, String subTypeCode, Integer referenceID, String abbvName, String currencyCode, String description, String configStatusCode, String ownerPartyCode, String addlCode01, String addlCode02, String addlCode03, String addlCode04, String addlCode05, String addlCode06, String addlCode07, String addlCode08, String addlCode09, String addlCode10, String addlCode11, String addlCode12, String addlCode13, String addlCode14, String addlCode15, String addlCode16, String addlCode17, String addlCode18, String addlCode19, String addlCode20, String activeCode, String statusCode, String createdOn, Long createdBy, String lastUpdatedOn, Long lastUpdatedBy, String lastAuthorisedOn, Long lastAuthorisedBy, Integer processID, Integer uploadRefID, String branchName, String branchCode, Integer attachmentID, String partySubTypeCode, String democracyTypeCode, String democracySubTypeCode, String constitutionTypeCode, String parentPartyCode, String systemSourceCode, String empCode, String taskReasonCode, String taskReasonText, String masterTemplate, String transactionType, String regStatus, String migrationStatusCode, String migrationSysCode, String migrationSysRefCode, String migrationDatetime, String stageCode, String boStatusCode, String boStatusReference, String boStatusReasson, String boStatusMessage, String portalEnablementStatusCode, String channel, String channelType, String template, List<FgPartyAddress> fgPartyAddresss, List<FgPartyContact> fgPartyContacts, List<FgPartyProfile> fgPartyProfiles, List<FgPartyRelation> fgPartyRelations, List<FgPartyRole> fgPartyRoles, List<FgScheduleCode> fgScheduleCodes, List<FgUser> fgUsers, List<FgParty> fgPartys, List<FgBusinessCode> fgBusinessCodes) {
    ...
    public static class Builder {
        ...
        private List<FgPartyAddress> fgPartyAddresss;

        private List<FgPartyContact> fgPartyContacts;

        private List<FgPartyProfile> fgPartyProfiles;

        private List<FgPartyRelation> fgPartyRelations;

        private List<FgPartyRole> fgPartyRoles;

        private List<FgScheduleCode> fgScheduleCodes;

        private List<FgUser> fgUsers;

        private List<FgParty> fgPartys;

        private List<FgBusinessCode> fgBusinessCodes;
        ...
        public Builder fgPartyAddresss(List<FgPartyAddress> fgPartyAddresss) {
            this.fgPartyAddresss = fgPartyAddresss;
            return this;
        }

        public Builder fgPartyContacts(List<FgPartyContact> fgPartyContacts) {
            this.fgPartyContacts = fgPartyContacts;
            return this;
        }

        public Builder fgPartyProfiles(List<FgPartyProfile> fgPartyProfiles) {
            this.fgPartyProfiles = fgPartyProfiles;
            return this;
        }

        public Builder fgPartyRelations(List<FgPartyRelation> fgPartyRelations) {
            this.fgPartyRelations = fgPartyRelations;
            return this;
        }
        ...
        public Builder fgScheduleCodes(List<FgScheduleCode> fgScheduleCodes) {
            this.fgScheduleCodes = fgScheduleCodes;
            return this;
        }

        public Builder fgUsers(List<FgUser> fgUsers) {
            this.fgUsers = fgUsers;
            return this;
        }

        public Builder fgPartys(List<FgParty> fgPartys) {
            this.fgPartys = fgPartys;
            return this;
        }

        public Builder fgBusinessCodes(List<FgBusinessCode> fgBusinessCodes) {
            this.fgBusinessCodes = fgBusinessCodes;
            return this;
        }

        public FgParty build() {
            return new FgParty(ID, versionID, isMasterVersion, isoCode, languageCode, name, timeZoneCode, typeCode, subTypeCode, referenceID, abbvName, currencyCode, description, configStatusCode, ownerPartyCode, addlCode01, addlCode02, addlCode03, addlCode04, addlCode05, addlCode06, addlCode07, addlCode08, addlCode09, addlCode10, addlCode11, addlCode12, addlCode13, addlCode14, addlCode15, addlCode16, addlCode17, addlCode18, addlCode19, addlCode20, activeCode, statusCode, createdOn, createdBy, lastUpdatedOn, lastUpdatedBy, lastAuthorisedOn, lastAuthorisedBy, processID, uploadRefID, branchName, branchCode, attachmentID, partySubTypeCode, democracyTypeCode, democracySubTypeCode, constitutionTypeCode, parentPartyCode, systemSourceCode, empCode, taskReasonCode, taskReasonText, masterTemplate, transactionType, regStatus, migrationStatusCode, migrationSysCode, migrationSysRefCode, migrationDatetime, stageCode, boStatusCode, boStatusReference, boStatusReasson, boStatusMessage, portalEnablementStatusCode, channel, channelType, template, fgPartyAddresss, fgPartyContacts, fgPartyProfiles, fgPartyRelations, fgPartyRoles, fgScheduleCodes, fgUsers, fgPartys, fgBusinessCodes);
        }
    }
}
