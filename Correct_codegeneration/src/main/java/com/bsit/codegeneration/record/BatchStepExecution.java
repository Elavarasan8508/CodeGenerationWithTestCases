...
public record BatchStepExecution(Integer stepExecutionID, Long version, String stepName, Integer jobExecutionID, String createTime, String startTime, String endTime, String status, Long commitCount, Long readCount, Long filterCount, Long writeCount, Long readSkipCount, Long writeSkipCount, Long processSkipCount, Long rollbackCount, String exitCode, String exitMessage, String lastUpdated, BatchJobExecution batchJobExecution, List<BatchStepExecutionContext> batchStepExecutionContexts) {
    ...
    public static class Builder {
        ...
        public BatchStepExecution build() {
            return new BatchStepExecution(stepExecutionID, version, stepName, jobExecutionID, createTime, startTime, endTime, status, commitCount, readCount, filterCount, writeCount, readSkipCount, writeSkipCount, processSkipCount, rollbackCount, exitCode, exitMessage, lastUpdated, batchJobExecution, batchStepExecutionContexts);
        }
    }
}
