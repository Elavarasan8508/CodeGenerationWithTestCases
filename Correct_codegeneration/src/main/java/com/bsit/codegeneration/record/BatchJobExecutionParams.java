...
public record BatchJobExecutionParams(Integer jobExecutionID, String parameterName, String parameterType, String parameterValue, String identifying, Long doubleVal, Long longVal, String dateVal, String keyName, String stringVal, String typeCd, BatchJobExecution batchJobExecution) {
    ...
    public static class Builder {
        ...
        public BatchJobExecutionParams build() {
            return new BatchJobExecutionParams(jobExecutionID, parameterName, parameterType, parameterValue, identifying, doubleVal, longVal, dateVal, keyName, stringVal, typeCd, batchJobExecution);
        }
    }
}
