...
public record FgTokenBk(Integer ID, String domainCode, String userName, Integer loginID, String tokenName, Long status, String reqSystem, String issuedOn, String accessedOn, Long valDuration, String reqTime, String expiresOn, String createdDate, Long createdBy, Long lastUpdatedBy, Long lastAuthorisedBy, String createdOn, String lastUpdatedOn, String lastAuthorisedOn, String tokenValue, String channel, String channelType) {
