...
public record CreditOfferPartyMap(Integer ID, Integer referenceID, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, Integer processID, String createdOn, Long createdBy, String lastUpdatedOn, Long lastUpdatedBy, String lastAuthorisedOn, Long lastAuthorisedBy, String template, String applicantParty, String fulfillmentParty, Integer attachmentID, Integer parentID, Integer parentRefID, Integer parentVersionID, Long isTemplate, Integer offerID, String mappingStatus, Integer versionID, Long isMasterVersion, Integer uploadRefID, Long usageLimit, Integer customerID, String crnBor, String accNo, String roi, Long procFee, Long overallLimit, String portfolio, String productCode, java.time.LocalDateTime validFrom, java.time.LocalDateTime validTo, String declarationType, String branchAddress, String branchLocation, Integer solid, String financialYear, String gstinNum, String typOfProcFee, Long minLoanAmt, Long maxLoanAmt, Long minTenureDays, Long maxTenureDays, String adhocType, Long existingFac, Long availableLoanLimit, Long sancLoanLimit, Long utlLoanDem, Long gst, Long spreadOfRoi, Long roiNextYr, String sancLtrRefno, Long roiBenchmark, String benchmark, Long adminChrgs, Long technicalFees, String remarks, Long gstNextYr, Long procFeesNextYr, String roiType, String msmeStatus, String pslStatus, String natureOfBusiness, String schemeCode, Integer limitID, String subsectorCode, String branchCode, String operationType, Integer userID, java.time.LocalDateTime uploadedDate, String subProductCode, String segmentCode, String segmentTeams, Long lineNo) {
    ...
    public static class Builder {
        ...
        public Builder solid(Integer solid) {
            this.solid = solid;
            return this;
        }
