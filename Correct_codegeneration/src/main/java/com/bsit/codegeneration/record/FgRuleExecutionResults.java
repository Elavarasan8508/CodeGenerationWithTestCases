...
public record FgRuleExecutionResults(Integer ID, Integer referenceID, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, Integer processID, String createdOn, Long createdBy, String lastUpdatedOn, Long lastUpdatedBy, String lastAuthorisedOn, Long lastAuthorisedBy, String template, String applicantParty, String fulfillmentParty, Long isTemplate, Integer parentRefID, String status, String guidance, String severity, String message, String objectReference) {
    ...
    public static class Builder {
        ...
        public Builder objectReference(String objectReference) {
            this.objectReference = objectReference;
            return this;
        }

        public FgRuleExecutionResults build() {
            return new FgRuleExecutionResults(ID, referenceID, typeCode, subTypeCode, activeCode, stageCode, statusCode, processID, createdOn, createdBy, lastUpdatedOn, lastUpdatedBy, lastAuthorisedOn, lastAuthorisedBy, template, applicantParty, fulfillmentParty, isTemplate, parentRefID, status, guidance, severity, message, objectReference);
        }
    }
}
