...
public record FgConfigSchema(Integer ID, String configCode, String name, String parentCode, String fieldData, String formData, String authFormData, String description, String activeCode, String statusCode, String createdOn, Long createdBy, String lastUpdatedOn, Long lastUpdatedBy, String lastAuthorisedOn, Long lastAuthorisedBy, String categoryCode, String typeCode) {
