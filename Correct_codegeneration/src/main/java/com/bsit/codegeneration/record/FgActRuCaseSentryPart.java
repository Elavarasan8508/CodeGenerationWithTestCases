...
public record FgActRuCaseSentryPart(String ID_, Long rev_, String caseInstID_, String caseExecID_, String sentryID_, String type_, String sourceCaseExecID_, String standardEvent_, String source_, String variableEvent_, String variableName_, Long satisfied_, String tenantID_, FgActRuCaseExecution fgActRuCaseExecution) {
    ...
    public static class Builder {
        ...
        public FgActRuCaseSentryPart build() {
            return new FgActRuCaseSentryPart(ID_, rev_, caseInstID_, caseExecID_, sentryID_, type_, sourceCaseExecID_, standardEvent_, source_, variableEvent_, variableName_, satisfied_, tenantID_, fgActRuCaseExecution);
        }
    }
}
