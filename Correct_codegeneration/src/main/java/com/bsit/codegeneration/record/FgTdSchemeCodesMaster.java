...
public record FgTdSchemeCodesMaster(Integer ID, Integer referenceID, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, Integer processID, String createdOn, Long createdBy, String lastUpdatedOn, Long lastUpdatedBy, String lastAuthorisedOn, Long lastAuthorisedBy, String template, String applicantParty, String fulfillmentParty, Long isTemplate, String tenor, String interestValue, String finSchemeCode, String interestCalculation, Long startTenor, Long endTenor, Integer versionID, Long isMasterVersion, String taskReason, Integer parentVersionID, Integer parentRefID, String origin, String accountSchemeCode, String tdType, Long minAmount, Long maxAmount, String tdRequest) {
