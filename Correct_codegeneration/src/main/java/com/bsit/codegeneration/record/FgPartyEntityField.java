...
public record FgPartyEntityField(Integer ID, String modelCode, Integer partyID, Integer partyVersionID, String name, Long isDeny, String activeCode, String statusCode, String createdOn, Long createdBy, String lastUpdatedOn, Long lastUpdatedBy, String lastAuthorisedOn, Long lastAuthorisedBy) {
