...
public record FgSdkReportTemplate(Integer ID, Integer referenceID, String applicantPartyCode, Integer applicantRefID, String issuingPartyCode, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, String createdOn, Long createdBy, String lastUpdatedOn, Long lastUpdatedBy, String lastAuthorisedOn, Long lastAuthorisedBy, String template, Long isTemplate, String partyCode, String reportType, String status, String entitySubTypeCode, String reportEngine, String fileTemplate, String name) {
    ...
    public static class Builder {
        ...
        public FgSdkReportTemplate build() {
            return new FgSdkReportTemplate(ID, referenceID, applicantPartyCode, applicantRefID, issuingPartyCode, typeCode, subTypeCode, activeCode, stageCode, statusCode, createdOn, createdBy, lastUpdatedOn, lastUpdatedBy, lastAuthorisedOn, lastAuthorisedBy, template, isTemplate, partyCode, reportType, status, entitySubTypeCode, reportEngine, fileTemplate, name);
        }
    }
}
