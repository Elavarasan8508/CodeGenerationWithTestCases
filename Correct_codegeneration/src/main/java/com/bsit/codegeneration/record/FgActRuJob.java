...
public record FgActRuJob(String ID_, Long rev_, String type_, String lockExpTime_, String lockOwner_, Long exclusive_, String executionID_, String processInstanceID_, String processDefID_, String processDefKey_, Long retries_, String exceptionStackID_, String exceptionMsg_, String duedate_, String repeat_, String handlerType_, String handlerCfg_, String deploymentID_, Long suspensionState_, String jobDefID_, Long priority_, Long sequenceCounter_, String tenantID_, String createTime_, Long repeatOffset_, String failedActID_, FgActGeBytearray fgActGeBytearray) {
