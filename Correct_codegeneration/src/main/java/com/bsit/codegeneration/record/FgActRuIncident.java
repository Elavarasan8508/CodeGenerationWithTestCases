...
public record FgActRuIncident(String ID_, Long rev_, String incidentTimestamp_, String incidentMsg_, String incidentType_, String executionID_, String activityID_, String procInstID_, String procDefID_, String causeIncidentID_, String rootCauseIncidentID_, String configuration_, String tenantID_, String jobDefID_, String failedActivityID_, FgActRuIncident fgActRuIncident, FgActRuJobdef fgActRuJobdef) {
    ...
    public static class Builder {
        ...
        private FgActRuIncident fgActRuIncident;
        ...
        public Builder fgActRuIncident(FgActRuIncident fgActRuIncident) {
            this.fgActRuIncident = fgActRuIncident;
            return this;
        }
        ...
        public FgActRuIncident build() {
            return new FgActRuIncident(ID_, rev_, incidentTimestamp_, incidentMsg_, incidentType_, executionID_, activityID_, procInstID_, procDefID_, causeIncidentID_, rootCauseIncidentID_, configuration_, tenantID_, jobDefID_, failedActivityID_, fgActRuIncident, fgActRuJobdef);
        }
    }
}
