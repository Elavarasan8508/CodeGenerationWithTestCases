...
public record FgActRuTask(String ID_, Long rev_, String executionID_, String procInstID_, String procDefID_, String caseExecutionID_, String caseInstID_, String caseDefID_, String name_, String parentTaskID_, String description_, String taskDefKey_, String owner_, String assignee_, String delegation_, Long priority_, String createTime_, String dueDate_, String followUpDate_, Long suspensionState_, String tenantID_, FgActReCaseDef fgActReCaseDef, FgActRuCaseExecution fgActRuCaseExecution, List<FgActRuIdentitylink> fgActRuIdentitylinks) {
    ...
    public static class Builder {
        ...
        private List<FgActRuIdentitylink> fgActRuIdentitylinks;
        ...
        public Builder fgActRuIdentitylinks(List<FgActRuIdentitylink> fgActRuIdentitylinks) {
            this.fgActRuIdentitylinks = fgActRuIdentitylinks;
            return this;
        }

        public FgActRuTask build() {
            return new FgActRuTask(ID_, rev_, executionID_, procInstID_, procDefID_, caseExecutionID_, caseInstID_, caseDefID_, name_, parentTaskID_, description_, taskDefKey_, owner_, assignee_, delegation_, priority_, createTime_, dueDate_, followUpDate_, suspensionState_, tenantID_, fgActReCaseDef, fgActRuCaseExecution, fgActRuIdentitylinks);
        }
    }
}
