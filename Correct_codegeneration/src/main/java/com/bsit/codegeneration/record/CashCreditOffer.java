...
public record CashCreditOffer(Integer ID, Integer referenceID, String typeCode, String subTypeCode, String activeCode, String stageCode, String statusCode, Integer processID, String createdOn, Long createdBy, String lastUpdatedOn, Long lastUpdatedBy, String lastAuthorisedOn, Long lastAuthorisedBy, String template, String applicantParty, String fulfillmentParty, Integer uploadRefID, Integer attachmentID, Integer parentID, Integer parentRefID, Integer parentVersionID, Long isTemplate, Integer offerID, String name, String description, String offerTypeCode, java.time.LocalDateTime offerStartDate, java.time.LocalDateTime offerEndDate, String interestTypeCode, Long rateOfInterest, String benchmarkCode, String resetFrequencyPeriodCode, String tenorUom, Long tenorMin, Long tenorMax, String processingModeCode, Long offerSpreadPercentage, Long ftpCode, Integer versionID, Long isMasterVersion, String productCode, String subProductCode, String segmentCode) {
