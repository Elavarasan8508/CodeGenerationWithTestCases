...
public record FgPartyError(Long ignore, String category, String severity, String typeCode, String subTypeCode, Integer partyReferenceID, String partyCode, String message, String details, java.time.LocalDateTime createdOn, java.time.LocalDateTime lastUpdatedOn, String parentPartyCode) {
