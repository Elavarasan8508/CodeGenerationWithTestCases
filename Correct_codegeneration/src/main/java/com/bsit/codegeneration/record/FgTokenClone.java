...
public record FgTokenClone(Integer ID, String domainCode, String userName, Integer loginID, String tokenName, Long status, String reqSystem, String issuedOn, String accessedOn, Long valDuration, String reqTime, String expiresOn, String createdDate, Long createdBy, Long lastUpdatedBy, Long lastAuthorisedBy, String createdOn, String lastUpdatedOn, String lastAuthorisedOn, String tokenValue, String channel, String channelType) {
    ...
    public static class Builder {
        ...
        public FgTokenClone build() {
            return new FgTokenClone(ID, domainCode, userName, loginID, tokenName, status, reqSystem, issuedOn, accessedOn, valDuration, reqTime, expiresOn, createdDate, createdBy, lastUpdatedBy, lastAuthorisedBy, createdOn, lastUpdatedOn, lastAuthorisedOn, tokenValue, channel, channelType);
        }
    }
}
