...
public record FgModCmsContent(Integer ID, Integer versionID, String ownerPartyCode, String ownerTypeCode, String spaceCode, String contentRefNo, String entityTypeCode, String entitySubTypeCode, String name, String title, String subTitle, String description, String contentData, Long isMasterVersion, String publishDate, String expireDate, String stageCode, String statusCode, String activeCode, Long createdBy, String createdOn, Long lastUpdatedBy, String lastUpdatedOn, Long lastAuthorisedBy, String lastAuthorisedOn) {
