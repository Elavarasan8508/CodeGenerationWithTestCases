...
public record FgAuditMaster(Integer uuid, String partyCode, String userCode, String categoryCode, String typeCode, String source, String endpointCode, String entityCode, String eventCode, String serverityCode, String statusCode, String occuredOn, Integer sessionID, String sessionAddress, Integer entityRefID, String relOrgCode, String relOrgSubTypeCode, String relOrgTypeCode, String relOrgParentCode, String tokenValue, String endsOn, List<FgAuditItem> fgAuditItems) {
    ...
    public static class Builder {
        ...
        private List<FgAuditItem> fgAuditItems;
        ...
        public Builder fgAuditItems(List<FgAuditItem> fgAuditItems) {
            this.fgAuditItems = fgAuditItems;
            return this;
        }

        public FgAuditMaster build() {
            return new FgAuditMaster(uuid, partyCode, userCode, categoryCode, typeCode, source, endpointCode, entityCode, eventCode, serverityCode, statusCode, occuredOn, sessionID, sessionAddress, entityRefID, relOrgCode, relOrgSubTypeCode, relOrgTypeCode, relOrgParentCode, tokenValue, endsOn, fgAuditItems);
        }
    }
}
