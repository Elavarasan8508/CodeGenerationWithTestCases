...
public record FgEntityCategory(Integer ID, String code, Long configStatusCode, String name, String parentCategoryCode, String description, String activeCode, String statusCode, String createdOn, Long createdBy, String lastUpdatedOn, Long lastUpdatedBy, String lastAuthorisedOn, Long lastAuthorisedBy) {
