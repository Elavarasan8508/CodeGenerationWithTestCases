...
public record FgActRuJobdef(String ID_, Long rev_, String procDefID_, String procDefKey_, String actID_, String jobType_, String jobConfiguration_, Long suspensionState_, Long jobPriority_, String tenantID_, String deploymentID_, List<FgActRuBatch> fgActRuBatchs, List<FgActRuIncident> fgActRuIncidents) {
    ...
    public static class Builder {
        ...
        private List<FgActRuBatch> fgActRuBatchs;

        private List<FgActRuIncident> fgActRuIncidents;
        ...
        public Builder fgActRuBatchs(List<FgActRuBatch> fgActRuBatchs) {
            this.fgActRuBatchs = fgActRuBatchs;
            return this;
        }

        public Builder fgActRuIncidents(List<FgActRuIncident> fgActRuIncidents) {
            this.fgActRuIncidents = fgActRuIncidents;
            return this;
        }

        public FgActRuJobdef build() {
            return new FgActRuJobdef(ID_, rev_, procDefID_, procDefKey_, actID_, jobType_, jobConfiguration_, suspensionState_, jobPriority_, tenantID_, deploymentID_, fgActRuBatchs, fgActRuIncidents);
        }
    }
}
