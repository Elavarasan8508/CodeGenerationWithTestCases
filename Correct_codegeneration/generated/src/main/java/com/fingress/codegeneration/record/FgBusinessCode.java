...
public record FgBusinessCode(Long ID, String name, String codeType, String codeValue, String parentCode, Long partyID, Long partyVersionID, String parentType, String description, String activeCode, String statusCode, String createdOn, Long createdBy, String lastUpdatedOn, Long lastUpdatedBy, String lastAuthorisedOn, Long lastAuthorisedBy, String template, String parentRefID, String tags) {
    ...
    public static class Builder {
        ...
        public FgBusinessCode build() {
            return new FgBusinessCode(ID, name, codeType, codeValue, parentCode, partyID, partyVersionID, parentType, description, activeCode, statusCode, createdOn, createdBy, lastUpdatedOn, lastUpdatedBy, lastAuthorisedOn, lastAuthorisedBy, template, parentRefID, tags);
        }
    }
}
