...
public record FgActReDecisionReqDef(String ID_, Long rev_, String category_, String name_, String key_, Long version_, String deploymentID_, String resourceName_, String dgrmResourceName_, String tenantID_) {
    ...
    public static class Builder {
        ...
        public FgActReDecisionReqDef build() {
            return new FgActReDecisionReqDef(ID_, rev_, category_, name_, key_, version_, deploymentID_, resourceName_, dgrmResourceName_, tenantID_);
        }
    }
}
