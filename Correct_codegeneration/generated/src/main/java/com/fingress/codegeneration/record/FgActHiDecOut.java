...
public record FgActHiDecOut(String ID_, String decInstID_, String clauseID_, String clauseName_, String ruleID_, Long ruleOrder_, String varName_, String varType_, String bytearrayID_, Long double_, Long long_, String text_, String text2_, String tenantID_, String createTime_, String rootProcInstID_, String removalTime_) {
    ...
    public static class Builder {
        ...
        public Builder ruleOrder_(Long ruleOrder_) {
        ...
        public FgActHiDecOut build() {
            return new FgActHiDecOut(ID_, decInstID_, clauseID_, clauseName_, ruleID_, ruleOrder_, varName_, varType_, bytearrayID_, double_, long_, text_, text2_, tenantID_, createTime_, rootProcInstID_, removalTime_);
        }
    }
}
