...
public record FgDmsContent(Long ID, String dmsDocPath, String dmsDocReferenceID, String fileContent, String fileName, String fileSize, String fileType, String title, Long dmsEventID, String description, String filePurposeCode, String dmsReference, String activeCode, String statusCode, String createdOn, Long createdBy, String lastUpdatedOn, Long lastUpdatedBy, String lastAuthorisedOn, Long lastAuthorisedBy) {
    ...
    public static class Builder {
        ...
        public FgDmsContent build() {
            return new FgDmsContent(ID, dmsDocPath, dmsDocReferenceID, fileContent, fileName, fileSize, fileType, title, dmsEventID, description, filePurposeCode, dmsReference, activeCode, statusCode, createdOn, createdBy, lastUpdatedOn, lastUpdatedBy, lastAuthorisedOn, lastAuthorisedBy);
        }
    }
}
